...
export default function Contact() {
    ...
    return (
        <div id="contact" className="w-full px-[12%] py-10 scroll-mt-20 bg-[url('./assets/footer-bg-color.png')] bg-no-repeat bg-[length:90%_auto] bg-center dark:bg-none">
            ...
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">Open to internships and entry-level Data Analyst roles.</p>
            ...
            <form onSubmit={onSubmit} className="max-w-2xl mx-auto">
                ...
                <textarea rows="6" placeholder="Your message" className="w-full px-4 py-2 focus:ring-1 outline-none border border-gray-300 dark:border-white/30 rounded-md bg-white mb-6 dark:bg-darkHover/30" required name="message"></textarea>
